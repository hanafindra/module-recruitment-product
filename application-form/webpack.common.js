...
module.exports = {
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      library: { type: "var", name: "application_form" },
  ...
  output: {
    ...
    filename: '[name].[contenthash].js', // Ensure each chunk has a unique name
    chunkFilename: '[name].[contenthash].js', // Ensure each chunk has a unique name
  },
  devServer: {
    port: 8000,
